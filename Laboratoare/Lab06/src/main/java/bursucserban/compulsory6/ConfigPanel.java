...
public class ConfigPanel {
	...
	public HBox create() {
		...
		xValueFactory.valueProperty().addListener((observable, oldValue, newValue) -> {x=newValue; System.out.println(x);});
		...
		yValueFactory.valueProperty().addListener((observable, oldValue, newValue) -> {y=newValue; System.out.println(y);});
